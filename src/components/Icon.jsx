...
// Icones inline (pas de dependance externe)
// Utilise comme: <Icon name="dashboard" size={16} />
...
const PATHS = {
  ...
  // Poignée de main (icône "équipe/collaboration")
  // Inspirée du design Lucide handshake : deux poings qui se rejoignent au centre.
  handshake: (
    <>
